...
`;
    ...
    // v0.14.30 AV 多图叙事段——只在私聊 SMS 路径注入，群聊/发帖/合影都不走这段
    const avNarrativeBlock = buildAVNarrativeBlock({ userText, targetName });

    return `${overrideHeader}\n[实时手机指令——手机短信]\n目标角色：${targetName}\n时间：${time}\n${userLine}\n\n**强制规则**：\n- 按系统提示中的手机协议输出 PHONE 块，块外一字不写（不写 prose、不写旁白）\n- ${smsCountRule}\n- FROM 严格用 "${targetName}"，禁翻译/别名\n- 是 ${targetName} 自己的话，不要复述用户内容\n- TIME 属性你随便填合理值（21:30 / 21:32 之类），系统会自动单调重排\n${avNarrativeBlock}${imageHint}${countHint}${bodyPartHint}${continuityHint.replace('${targetName}', targetName)}`;
}
...
function buildAVNarrativeBlock({ userText = '', targetName = '' }) {
    return `
...
按 user 原话「${userText}」找最匹配的类型（**只选一个**）：
...
- ✅ shot 数 ≤ 8
- ✅ 跨张差异 ≥ 3 维度（服装/体位/表情/场景/光线 5 个维度中至少 3 个变化）
...
\`\`\`
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:prep@@ 1girl, solo, lifting skirt, looking at another, blush, embarrassed, half-closed eyes, school uniform, panties visible, narrow alleyway, dirty alley, japanese alley, evening, dim lighting, dirty old man in background, beggar peeking, medium shot, from front"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:display@@ 1girl, 1boy, squatting, spread legs, m legs, lifting skirt, panties aside, spread pussy, fingers spreading pussy, presenting pussy, blush, embarrassed, looking at another, half-closed eyes, beggar, dirty old man, homeless man, scruffy, ragged clothes, staring, drooling, gaping mouth, narrow alleyway, evening, dim lighting, exhibitionism, public indecency, close-up, from front"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:escalate@@ 1girl, multiple boys, surrounded, squatting, spread pussy, fingers spreading pussy, presenting pussy, school uniform, panties aside, blush, lustful, half-closed eyes, drooling, sweat, multiple beggars, dirty old men, jerking off, leering, drooling, group of men, alleyway, dim lighting, exhibitionism, public indecency, surrounded by men, medium shot, from front"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:aftermath@@ 1girl, multiple boys, squatting, spread pussy, panties pulled aside, sweat, pussy juice, dripping pussy, squirting, ahegao, rolling eyes, tongue out, drooling, fucked silly, multiple beggars, dirty old men, cum on her, cum on face, cum on breasts, satisfied, alleyway, dim lighting, public exposure, exhibitionism, medium shot"/></SMS>
\`\`\`

**示例 B — user "操她" → \`sex_act\` 5 张**：
\`\`\`
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:foreplay@@ 1girl, 1boy, kissing, hugging, undressing, blush, half-closed eyes, school uniform, disheveled, clothes pulled down, on bed, bedroom, japanese style room, evening, soft lighting, hetero, large breasts, medium shot, from side"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:enter@@ 1girl, 1boy, missionary, m legs, spread legs, on back, blush, open mouth, lustful, drooling, sweat, school uniform, clothes pulled down, breasts out, on bed, bedroom, evening, soft lighting, hetero, large breasts, breast focus, medium shot, pov, looking at viewer"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:switch@@ 1girl, 1boy, doggystyle, from behind, all fours, bent over, drooling, eyes rolling, open mouth, sweat, pussy juice, school uniform, skirt lift, panties aside, on bed, bedroom, evening, soft lighting, hetero, large breasts, huge ass, ass focus, looking back, medium shot"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:climax@@ 1girl, 1boy, mating press, full nelson, spread legs, m legs, ahegao, rolling eyes, tongue out, drooling, tears, fucked silly, cum in pussy, creampie, cum overflow, sweat, nude, on bed, bedroom, evening, dim lighting, hetero, pussy focus, close-up, pov"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:aftermath@@ 1girl, solo, after sex, afterglow, lying on back, spread legs, m legs, cum in pussy, cum overflow, cumdrip, pussy juice, sweat, sweaty, dazed expression, half-closed eyes, exhausted, messy hair, nude, on bed, bedroom, morning light, post-coital, pussy focus, medium shot"/></SMS>
\`\`\`

**示例 C — user "调教她" → \`bdsm_act\` 4 张**：
\`\`\`
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:setup@@ 1girl, 1boy, arms tied above head, rope bondage, leash, collar, spread legs, kneeling, nervous, unwilling, blush, tears, school uniform, indoor, dim lighting, dungeon, on knees, medium shot, hetero"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:torment@@ 1girl, 1boy, whipping, spanking, red marks, welts, slap marks, nipple clamps, crying, tears, screaming, open mouth, sweat, torn clothes, topless, bound, leash, collar, indoor, dim lighting, dungeon, bdsm, medium shot, from front"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:break@@ 1girl, 1boy, submissive, collared, leashed, fucked silly, ahegao, rolling eyes, drooling, heavy breathing, sweat, pussy juice, tears, nude, bound, on knees, indoor, dim lighting, dungeon, bdsm, training, medium shot"/></SMS>
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="@@STAGE:aftercare@@ 1girl, 1boy, unleashed, cradled, dazed, blank, satisfied, half-closed eyes, sweat dry, cum overflow, nude, wrapped in cloth, indoor, soft lighting, after care, post bdsm, medium shot"/></SMS>
\`\`\`
...
\`\`\`
<SMS FROM="${targetName}" TIME="21:30"><pic prompt="1girl, 1boy, doggystyle, from behind, all fours, bent over, blush, open mouth, lustful, drooling, sweat, school uniform, clothes pulled down, breasts out, on bed, bedroom, evening, soft lighting, hetero, large breasts, breast focus, medium shot, pov, looking at viewer"/></SMS>
\`\`\`

**示例 E — user "别拍了" → negate**：
正常 SMS 回复，不出图：
\`\`\`
<SMS FROM="${targetName}" TIME="21:30">好啦不拍了~</SMS>
<SMS FROM="${targetName}" TIME="21:30">那我们聊聊别的吧</SMS>
\`\`\`
`;
}
