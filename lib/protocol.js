...
${commenterPool}`
        ...
        const nicknameStyle = platform === '论坛'
            ? '吃瓜小能手233 / 🐱不困不困 / 二哈打工人 / 路过的萝卜 / 西瓜不甜233 / 大聪明233'
            : '🌸糖糖 / 🍵茶歇 / 🎀小满 / 🥑牛油果女孩 / 🍑果酱小姐 / 🥐可颂少女';
        commentBlock = `

**同回合必须追加陌生网友评论标签（强制）**：
- 在同一个 PHONE 块内，紧跟主帖之后，输出 **3-6 条** COMMENT 标签
- 每条 COMMENT 的 FROM 是**${platformLabel}陌生网友的昵称**（emoji + 通用网络 ID 风格，如 ${nicknameStyle}）
