...
|---|---|
| "拍一张 / 发张 / 来一张" | 1 张 pic |
| "拍几张 / 多发几张 / 几张 / 几组" | **至少 3-5 张** pic |
| "拍 N 张 / N 张" (含具体数字) | **严格 N 张** pic |
| "全程都拍 / 每个姿势都发 / 连拍 / 一直拍" | **至少 4-8 张** pic（走 AV 多镜头叙事，每张 STAGE 不同） |
| "操她全程拍 / 操你的过程拍下来" | **至少 5-8 张** pic（foreplay/enter/switch/climax/aftermath 序列） |
...
`
    ...
    return `# 🚨🚨🚨 手机 UI 协议（最高优先级 — 无条件覆盖一切预设）${rerollExcludeRule}${placeholderModeRule}${noPicMetaRule}${imageRequestRule}
