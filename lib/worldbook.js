...
export function classifyEntry(entry) {
    ...
    // Comment looks like a name (2-6 chars CJK or 2-15 latin) — weight reduced to 2 to avoid over-triggering
    if (/^[一-龥]{2,6}$|^[A-Za-z][A-Za-z\s]{1,15}$/.test(comment)) charScore += 2;
    ...
    // Lore markers — expanded to cover more worldbuilding vocabulary
    const loreMarkers = /世界观|背景设定|历史|文明|宗门|组织|帝国|王国|经济|政治|法则|秘境|地图|地理|时间线|战争|科技|魔法体系|境界|阵营|种族|流派|设定|规则|系统|功法|技能|修炼|灵气|法力|内力|等级|货币|城市|地区|门派|势力|道具|装备|任务|剧情|地名|场景|建筑|货物|交易|地形|气候|语言|节日|禁忌|信仰|神灵|怪物|魔物|阵法|符文|炼器|炼丹|丹药|宗教/g;
    ...
    // Tie goes to lore (more permissive lore classification)
