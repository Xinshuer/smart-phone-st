            ...
            <section class="phone-settings-section">
                ...
                <select id="phone-model-select" class="phone-select">
                    ...
                    <optgroup label="写实">
                        ...
                        <option value="nova_asian_il" ${s.imageGen.currentModel === 'nova_asian_il' ? 'selected' : ''}>Nova Asian XL IL v5 (Illustrious 亚洲写实)</option>
                        <option value="lustify_v8" ${s.imageGen.currentModel === 'lustify_v8' ? 'selected' : ''}>LUSTIFY! v8 Apex (写实 NSFW 旗舰·原生 1536px)</option>
                    </optgroup>
                </select>
                <label class="phone-settings-row">
                    💻 ComfyUI 地址（电脑）
