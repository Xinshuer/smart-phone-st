...
function renderMomentCard(p, contact, userName) {
    ...
    const picHtml = p.pic
        ? `<div class="phone-image-slot" data-pic="${escapeHtml(p.pic)}" style="max-width:180px;margin-top:6px;">📷 生成中…</div>`
        : '';
...
export function bindMomentsHandlers(root, { onRefresh, onCompose, onBackToFeed, onSubmit, onLike, onComment }) {
