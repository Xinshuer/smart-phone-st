...
export const BOARDS = ['情感吧', '搞笑吧', '八卦吧', '美食吧', '旅游吧', '日常吧', '吐槽吧', '游戏吧'];
...
function renderDetail(chatId, postId) {
    ...
    const sourceFlag = p.from === 'user' ? 'forum_user' : (p.commandedByUser ? 'forum_command' : 'forum');
            ...
            <div class="tb-detail-body">
                ...
                <div class="tb-replies">
                    ${replies.length
                        ...
                        : '<div class="phone-empty-inline" style="padding:20px;text-align:center;">暂无回复</div>'}
                </div>
            </div>
...
export function bindForumHandlers(root, { onRefresh, onClear, onOpenPost, onBackToFeed, onCompose, onSubmit, onReply }) {
