...
- pic 英文 booru tag 描述帖子主配图场景（8-15个tag，逗号分隔），**pic 必须跟 title/body 主题匹配 + 跟当前世界观契合**，参考分类：
  ...
  【⚠️ 构图视角铁律 — 必读】**默认第三人称构图，selfie 仅例外**
  小红书帖子大部分是**第三人称/物视角**（旅行背影、抓拍、物品近景、food top-down 等），
  **仅以下场景**可用 selfie：
    · OOTD 穿搭：mirror selfie 镜子前自拍
    · 美妆/护肤教程：selfie + 脸部特写
    · 自我介绍/化形/cosplay 写真：selfie 可用
  **其他场景一律禁 selfie + looking at viewer**，改用 third person / candid / from behind / from side / from above 等多样视角。

  【通用类·任何世界观都适用】
  · 穿搭 / OOTD / 美妆（**可 selfie**）→ \`1girl, mirror selfie, full body, casual outfit, looking at viewer\`
  · 旅行 / 风景 / 第三人称分享 → \`1girl, from behind, scenic vista, full body, looking away, golden hour\` 或 \`scenery, landscape, no humans\`
  · 美食 / 探店 → \`food photography, dish, top down view, restaurant table, no humans\`
  · 物品 / 开箱 / 收藏 → \`still life, object, close up, no humans\`
  · 八卦 / 抓拍 / 偶遇 → \`candid photo, from a distance, telephoto, third person view, voyeur angle\`
  · 日常吐槽 / 心情 → \`indoor scene, no humans, mood photo\` 或 \`1girl, from side, sitting alone, looking away\`
