...
- tag ${tagOptions}
- pic 英文 booru tag 描述帖子主配图场景（8-15个tag，逗号分隔），**pic 必须跟 title/body 主题匹配**，参考下方分类：
  · 自拍 / 穿搭 / 出片 / 妆容主题 → 人像：\`1girl, casual outfit, looking at viewer, park, sunny day, mirror selfie\`
  · 美食 / 探店 / 厨房主题 → 食物：\`food photography, dish, ramen bowl, restaurant table, appetizing, top down view, warm lighting\`
  · 旅行 / 风景 / 探秘主题 → 风景：\`scenery, mountain landscape, cherry blossoms, golden hour, wide shot, no humans\`
  · 物品 / 开箱 / 拍卖 / 收藏主题 → 物品：\`still life, artifact, jade pendant, ancient relic, museum display, close up, no humans\`
  · 修仙 / 灵宠 / 秘境 / 法宝主题 → 玄幻物：\`magical artifact, glowing runes, ancient sword, mystical aura, fantasy art, no humans\` 或 \`cultivation, ink wash painting, mountain peak, immortal aesthetic\`
  · 八卦 / 吃瓜 / 抱怨主题 → 场景：\`indoor scene, no humans, atmospheric, mood photo\` 或随主题选合适场景
