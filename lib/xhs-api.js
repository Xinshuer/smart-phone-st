...
- pic 英文 booru tag 描述帖子主配图场景（8-15个tag，逗号分隔），**pic 必须跟 title/body 主题匹配 + 跟当前世界观契合**，参考分类：
  ...
  【通用类·任何世界观都适用】
  · 自拍 / 穿搭 / 妆容 → 人像：\`1girl, casual outfit, looking at viewer, indoor, soft lighting, mirror selfie\`
  · 美食 / 探店 / 厨房 → 食物：\`food photography, dish, ramen bowl, restaurant table, appetizing, top down view\`
  · 旅行 / 风景 → 风景：\`scenery, landscape, golden hour, wide shot, no humans\`
  · 物品 / 开箱 / 收藏 → 物品：\`still life, object, close up, no humans\`
  · 八卦 / 吐槽 / 日常 → 场景：\`indoor scene, no humans, atmospheric, mood photo\`
