...
- pic 英文 booru tags 描述帖子主图场景（8-12个tag，逗号分隔），**pic 必须跟 title/content 主题匹配 + 跟当前世界观契合**：
  ...
  写 pic 前**反问自己**：
  1. 现实贴吧里发这种主题的人会用什么图？（真人不会全部自拍 — 截图 / 物品 / 事件 / 抓拍占大头）
  2. 帖子焦点是谁/什么？（楼主自己 / 物品 / 别人 / 事件）
  3. anime 模型默认 1girl-front-portrait 不抗就出戏 → 主动用视角 tag

  【参考真实贴吧配图模式】
  · 楼主"我看到 X / 我偶遇 X" → **第三人称抓拍** \`candid photo, from a distance, telephoto, voyeur angle\` + 看到的物/人
  · 楼主"我捡到 / 我买到 / 我开箱" → **物品近景** \`no humans, close up, still life, object focus\` 或 \`hands holding, partial body, close up\`（半身露手不露脸）
  · 楼主"师尊/老板/X 又骂我了"类抱怨 → **第三人称** 拍那个人 \`1girl/1boy, from behind, scene composition\` 或楼主郁闷自拍 \`1girl, dejected expression, sitting alone\`
  · 楼主"今日穿搭/打卡/晒自拍" → **可 selfie** \`1girl, mirror selfie, full body, casual outfit\`
  · 楼主"吃瓜/八卦/猜测" → **截图风/路人远景** \`screenshot style, telephoto, from a distance\`
  · 楼主"求建议/求科普"类 → **示意图/对比图** \`comparison, side by side, no humans\` 或 \`1girl, from side, thinking\`
  · 楼主"美食/探店" → **食物 top-down** \`food photography, top down view, no humans\`
  · 楼主"旅行/打卡景点" → **风景** \`scenery, landscape, no humans\` 或 \`1girl, from behind, scenic vista\`

  ⚠️ 严禁默认 \`1girl, looking at viewer, selfie\` 套娃 — 物品帖/事件帖/旁观帖全用这套就出戏。
