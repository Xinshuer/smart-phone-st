...
- pic 英文 booru tags 描述帖子主图场景（8-12个tag，逗号分隔），**pic 必须跟 title/content 主题匹配**：
  · 自拍 / 穿搭主题 → 人像：\`1girl, casual outfit, looking at viewer, indoor, soft lighting\`
  · 美食 / 探店主题 → 食物：\`food photography, dish, restaurant, top view, appetizing\`
  · 旅行 / 风景主题 → 风景：\`scenery, landscape, golden hour, wide shot, no humans\`
  · 物品 / 开箱 / 收藏 / 拍卖主题 → 物品：\`still life, object, close up, no humans\`
  · 修仙 / 灵物 / 法宝 / 秘境主题 → 玄幻物：\`magical artifact, glowing runes, mystical aura, no humans\`
  · 八卦 / 吐槽 / 日常主题 → 场景：\`indoor scene, no humans, atmospheric\` 或随主题选
